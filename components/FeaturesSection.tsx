...
import { Star, Heart, Diamond, ShoppingCart } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Experience the finest ingredients for your skin'
    },
    {
      icon: Heart,
      title: 'Cruelty-Free',
    ...
    },
    {
      ...
      description: 'Beautifully designed to enhance your vanity'
    },
    {
      icon: ShoppingCart,
      title: 'Exclusive Collections',
      description: 'Limited edition products for the discerning customer'
    }
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-800 max-w-3xl mx-auto">
            Discover the exquisite features that set our cosmetics apart
          </p>
        </motion.div>
