      ...
      <div className="container mx-auto px-6 py-20">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            >
              We would love to hear from you! Let's create something beautiful together.
            </motion.p>
          </div>
        </ScrollReveal>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:border-pink-400"
                    required
                  />
                </div>
                <div>
                ...
                <div>
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:border-pink-400 resize-none"
                    required
                  />
                </div>
