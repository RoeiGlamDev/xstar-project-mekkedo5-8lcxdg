...
export default function ParallaxSection() {
  ...
  return (
    <div ref={ref} className="relative h-screen overflow-hidden">
      <motion.div
        style={{ y, opacity }}
        className="absolute inset-0 bg-gradient-to-br from-pink-600 via-white to-pink-300"
      />
      ...
      >
        <div className="text-center">
          ...
          >
            Luxury Beauty Awaits
          </motion.h2>
          <motion.p
            style={{ y: useTransform(scrollYProgress, [0, 1], ["10%", "-10%"]) }}
            className="text-xl text-gray-800 max-w-2xl mx-auto"
          >
            Discover the elegance of our premium cosmetics collection
          </motion.p>
        </div>
      </motion.div>
    </div>
